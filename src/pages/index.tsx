  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="SP PAY - Your one-stop solution for mobile recharge, Aadhar IPS service, bill payments, IMPS, and sending money effortlessly."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1622534138722-895a7deb9f49?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxtb2JpbGUlMjByZWNoYXJnZXxlbnwwfHx8fDE2OTk5NjgxOTR8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`SP PAY - Your one-stop solution for mobile recharge, Aadhar IPS service, bill payments, IMPS, and sending money effortlessly.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Account Manager" type="default" abilities={appConfig.ownerAbilities} />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
